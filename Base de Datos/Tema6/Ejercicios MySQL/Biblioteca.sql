...
-- Ejercicio 1 --
/*Realiza una consulta para ver todos los libros con sus autores*/
...
-- Ejercicio 2 --
/*Obtener los préstamos activos con los nombres de usuario y libros*/

select usuarios.nombre as nombre_usuario, libros.titulo as titulo_libro, prestamos.fecha_prestamo, prestamos.fecha_devolucion
from prestamos
join usuarios on prestamos.id_usuario = usuarios.id_usuario
join libros on prestamos.id_libro = libros.id_libro
where prestamos.fecha_devolucion >= '2025-02-28';
